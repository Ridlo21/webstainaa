...
class Model_app extends CI_model
{
    ...
    {
        return $this->db->query("SELECT * FROM $table where  password='" . $this->db->escape_str($password) . "' AND blokir='N'");
    }
    
    public function cek_user($username, $table)
    {
        return $this->db->query("SELECT * FROM $table where username='" . $this->db->escape_str($username). "' AND blokir='N'");
    }
