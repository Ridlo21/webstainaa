...
echo "</td></tr>
                    ...
                    <tr><th scope='row'>Link Youtube</th>               <td><input type='text' class='form-control' name='e' placeholder='Contoh link: https://www.youtube.com/embed/xbuEmoRWQHU'> </td></tr>
                    <tr><th scope='row'></th>                    <td><div class='checkbox-scroll'>";
// foreach ($tag as $tag) {
